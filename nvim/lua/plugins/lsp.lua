                ...
                settings = {
                    gopls = {
                        ...
                        analyses = {
                            ...
                            shadow = false,        -- Expensive: variable shadowing detection
                        },
                        staticcheck = false,       -- Enable staticcheck analysis
                    },
                    codelenses = {
                        generate = false,   -- Can be expensive in large codebases
                        gc_details = false, -- Definitely disable (expensive)
                    },
                },
            },
